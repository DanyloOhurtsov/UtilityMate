...
function calculatorFunc(){
    let resultCalcBlock = document.querySelector('.resultCalc')
    resultCalcBlock.style.maxHeight = resultCalcBlock.scrollHeight+'px';
    // OPEN CLOSE ITEM FUNC
    ...
    function addNewItemFunc(){
        ...
        // REMOVE ITEM
        let removeItemBtn = newItem.querySelectorAll('.removeItem');
        removeItemBtn.forEach(item => removeItemFunc(item));
        // OPEN CLOSE ITEM
        openItemBtn = newItem.querySelectorAll('.openItem');
    ...
    function addCatFun(){
        ...
        openCategoryBtn = document.querySelectorAll('.openCategory');
        console.log(openCategoryBtn)
        openCategoryBtn.forEach(item => openItemFunc(item));
